 ...
 * @param {String} header optional header if requesting specific info - consult TBA API
 * @param {Boolean} raw optional config for raw JSON output instead of preformatted array. Will not output to cells
 */
 ...
 * @param {String} endpoint endpoint to the requested data - consult TBA API for valid endpoints.
 * @param {String} query optional header if requesting specific info - consult TBA API
 * @param {Boolean} raw optional config for raw JSON output instead of preformatted array. Will not output to cells
 */
